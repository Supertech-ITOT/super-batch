...
import { resetFirstPasswordDefaultValues, resetFirstPasswordSchema, ResetFirstPasswordSchema } from "../schemas/reset-first-password-schema";


export default function ResetFirstPasswordForm() {
    const { mutateAsync, isPending } = useResetFirstPassword();
    const router = useRouter();
    const { handleSubmit, register, watch, formState: { isDirty, isSubmitting, } } = useForm<ResetFirstPasswordSchema>({
