...
import { loginDefaultValues, loginSchema, LoginSchema } from "../schemas/login-schema";
...
export default function LoginForm() {
    ...
    const { handleSubmit, register, watch, formState: { isDirty, isSubmitting, } } = useForm<LoginSchema>({
