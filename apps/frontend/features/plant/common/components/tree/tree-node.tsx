            ...
            >
                ...
                <ContextMenu>
                    ...
                    <ContextMenuContent>
                        ...
                        {node.type === "equipment" && (<ContextMenuItem onClick={() => onAction("unassign", node)}>Unassign Equipment </ContextMenuItem>)}
                        {node.type === "unit" && (<ContextMenuItem onClick={() => onAction("assign", node)}> Assign Equipment</ContextMenuItem>)}
