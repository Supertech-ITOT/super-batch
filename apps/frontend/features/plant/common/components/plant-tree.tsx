...
export default function PlantTree() {
    ...
    if (isError) {
        return (
            <div className="flex h-full items-center justify-center flex-1 text-sm text-destructive">
    ...
    if (!data || data.length === 0) {
        return (
            <div className="flex h-full items-center justify-center flex-1 text-sm text-muted-foreground">
