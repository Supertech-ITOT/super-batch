...
public class LicenseServerClientImpl implements LicenseServerClient {
    ...
    @Override
    public TrialLicenseActivationResponse activateTrial(TrialActivationRequest request) {
        return licenseServerRestClient.post()
                .uri("/api/licenses/trial")
                .body(request)
                .retrieve()
                .body(TrialLicenseActivationResponse.class);
    }

    @Override
    public TrialLicenseActivationResponse activateLicense(LicenseKeyActivationRequest request) {
        return licenseServerRestClient.post()
