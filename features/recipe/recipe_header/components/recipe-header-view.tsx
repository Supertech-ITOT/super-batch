...
import { useGetRecipeHeaders } from "../hooks/use-recipe-header";
import { Skeleton } from "@/common/components/ui/skeleton";
import { Separator } from "@/common/components/ui/separator";
import CreateRecipeHeaderDialog from "./create-recipe-header-dialog";
            ...
            </div>
            {
                <>
                    {dialog.action === "create" && (
                        <CreateRecipeHeaderDialog open onClose={closeDialog} />)}
                    ...
                    {dialog.action === "delete" && dialog.id !== null && (
                        <DeleteRecipeHeaderDialog open={dialog.open} recipeHeaderId={dialog.id} onClose={closeDialog} />)}
                </>
            }
